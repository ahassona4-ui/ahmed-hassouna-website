...
- section_id: tool-selection-comes-later
  ...
  body:
    ar: عندما يصبح الإطار التشغيلي واضحًا، يمكن اختيار الأداة التي تخدمه بأقل تعقيد. وعندها تصبح التقنية امتدادًا للنظام، لا بديلًا عنه.
    en: Once the operating framework is clear, the tool can be selected with less complexity. Technology then becomes an extension of the system, not a substitute for it.
quote:
